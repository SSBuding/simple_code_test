...
!(function (t, e) {
  ...
  function Fb(t) {
    ...
    if (((Et.lastIndex = 0), Et.test(r)))
      return (e = zt.test(r)), (t[1] = Cb(t[1], e)), (t[0] = Cb(t[0], e, Bb(t[1]))), !0
  }
  function Ob(t) {
    var e = (t + '').split('('),
      r = It[e[0]]
    ...
    return (
      ha(t, function (t) {
        for (var e in ((It[t] = ot[t] = a), (It[(n = t.toLowerCase())] = r), a))
          It[n + ('easeIn' === e ? '.in' : 'easeOut' === e ? '.out' : '.inOut')] = It[t + '.' + e] =
            a[e]
      }),
      a
    )
            ...
            ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                ...
                e ||
                  (t < 0 && !_) ||
                  (!v && !_ && m) ||
                  (St(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0),
          ...
          if (
            ...
            for (a in i)
              pt[a] && (f = ac(a, i, t, d, o, z))
                ? f.priority && (u = 1)
                : (c[a] = s = Qt.call(t, o, a, 'get', i[a], d, z, 0, m.stringFilter))
          t._op && t._op[n] && t.kill(o, t._op[n]),
            R &&
              t._pt &&
              ((Nt = t), L.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Nt = 0)),
            t._pt && T && (dt[h.id] = 1)
        }
          ...
          if (Z(x))
            ...
            for (l in u)
              for (
                ...
                ((D = { ease: (P = C[o]).e, duration: ((P.t - (o ? C[o - 1].t : 0)) / 100) * _ })[
                  l
                ] = P.v),
                  s.to(S, D, E),
                  (E += D.duration)
            ...
            if (
              ...
              e < 0 && Ca(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  ...
                  r ||
                    B ||
                    (St(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()))
  ...
  var Ce = {
    ...
    exportRoot: function exportRoot(t, e) {
      ...
      for (
        ...
        (i = r._next),
          (!e && !r._dur && r instanceof Jt && r.vars.onComplete === r._targets[0]) ||
            ...
            for (r in e)
              for (i = a.length; i--; )
                (n = (n = t._ptLookup[i][r]) && n.d) &&
                  (n._pt && (n = Ic(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r))
          })(t, n)
        }
      }
    }
  ...
  function Id(t, e) {
    ...
    if (t in nr) {
      ...
      if (
        ...
        return
      i._gsap.svg && ((this.svgo = i.getAttribute('data-svg-origin')), this.props.push(dr, e, '')),
        (t = cr)
    }
  ...
  function Kd() {
    ...
    for (t = 0; t < r.length; t += 3)
      r[t + 1]
        ...
        ? (n[r[t]] = r[t + 2])
        : n.removeProperty(
            '--' === r[t].substr(0, 2) ? r[t] : r[t].replace(ur, '-$1').toLowerCase()
          )
    if (this.tfm) {
  ...
  function Nd(t, e) {
    var r = Ee.createElementNS
      ? Ee.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : Ee.createElement(t)
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ('all' === o || !0 === o) (s.cssText = ''), (i = 1)
        ...
        for (n = (o = o.split(',')).length; -1 < --n; )
          (r = o[n]), nr[r] && ((i = 1), (r = 'transformOrigin' === r ? dr : cr)), Wd(a, r)
      i &&
        (Wd(a, cr),
        u && (u.svg && a.removeAttribute('transform'), xr(a, 1), (u.uncache = 1), Jd(s)))
    }
  }
  function he(t) {
  ...
  var De,
      ...
      return (
        ...
        nr[e] && 'transform' !== e
          ...
          : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) ||
            (n = (Tr[e] && Tr[e](t, e, r)) || Od(t, e) || ga(t, e) || ('opacity' === e ? 1 : 0)),
    ...
    xr = function _parseTransform(t, e) {
      ...
      return (
        ...
        r.svg &&
          ((M = r.uncache
            ? ((A = t.getBBox()), (Y = r.xOrigin - A.x + 'px ' + (r.yOrigin - A.y) + 'px'), '')
          ...
          if ('autoRound' !== c && ((o = e[c]), !pt[c] || !ac(c, e, i, n, t, a)))
            if (
              ...
              if (
                ...
                c in fr &&
                  ('autoAlpha' === c &&
                    (1 === h && 'hidden' === vr(t, 'visibility') && u && (h = 0),
                ...
                if (
                  ...
                  g ||
                    ...
                    ((g = this._pt =
                      new ge(this._pt, x, cr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                  'scale' === c)
                )
                  (this._pt = new ge(
                    this._pt,
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !lr.test(o) && c in x))
                (u = u || 0),
                  (d = (s + '').substr((h + '').length)) !==
                    (p = Ya(o) || (c in V.units ? V.units[c] : d)) && (h = $d(t, c, s, p)),
                  (this._pt = new ge(
                    this._pt,
                    m ? v : x,
                    c,
                    h,
                    (_ ? ka(h, _ + u) : u) - h,
                    m || ('px' !== p && 'zIndex' !== c) || !1 === e.autoRound ? ud : xd
                  )),
                  (this._pt.u = p || 0),
